                ...
                <div class="col">
                    ...
                    <main id="main" class="site-main">
                        ...
                        <header class="page-header mb-4">
                            <h1>News type: <?php single_term_title(); ?></h1>
                        ...
                        <div class="rss-feed pt-3">
                            <a class="rss-feed-icon fs-1" href="<?php echo esc_url(home_url()); ?>/news_type/<?php echo get_queried_object()->slug; ?>/feed/"  title="Subscribe to <?php single_term_title(); ?> e-news updates">
